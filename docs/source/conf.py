...
project = "pointtorch"
author = ", ".join([name.split(" <")[0] for name in metadata.metadata("pointtorch")["Author-email"].split(", ")])
copyright = f"{datetime.now().year}, {author}."
# the package version can be either specified via the env variable POINTTORCH_VERSION or read from the installed package
release = os.environ.get("POINTTORCH_VERSION", metadata.version("pointtorch"))
summary = metadata.metadata("pointtorch")["Summary"]
base_url = "https://ai4trees.github.io/pointtorch"
...
theme_options = ThemeOptions(
    ...
    main_nav_links={"Docs": "/pointtorch/index", "Changelog": "/changelog", "Development": "/development"},
    logo_light="../assets/pointtorch-icon-light-mode.png",
    logo_dark="../assets/pointtorch-icon-dark-mode.png",
    extra_header_link_icons={
        "repository on GitHub": {
            "link": "https://github.com/ai4trees/pointtorch",
            "icon": (
...
html_logo = ""
html_favicon = "../assets/pointtorch-favicon-128x128.png"
